...
%% Epigraph
\chapter*{}
\epigraph{""\textit{No one know nothing,\\everyone know something,\\but something is nothing to someone,\\while\\something is important to everybody}''}{Daudi, Manyara}
...
\input{./tex/Chapter2/SuperResolution.tex}
...
\input{./tex/Chapter2/Segmentation.tex} % OR rFBP
...
\input{./tex/Chapter3/WebScraping.tex}
...
\input{./tex/Chapter3/QueryExamples.tex}
...
\input{./tex/Appendix/Profiling.tex}
