...
This behavior highlights the results of the optimizations performed on the \textsf{Cython} implementation which allows the application of the \textsf{DNetPRO} algorithm also to larger datasets without loosing performances.
...
Despite of this, the computational efficiency of the \textsf{Cython} implementation is much better than the \textsf{Python} one, of which the usage is indisputable.
