...
With this purposes we have chosen to operate a \quotes{double wrap} of the \textsf{C++} functions to separate as much as possible the \textsf{C++} components from \textsf{Python}\footnote{
