...
The Python version of the algorithm (see next sections) can be installed via \textsf{setup.py} and the compilable parts of it checked via \emph{CMake} or \emph{Makefile}.
