...
} can be computed as dot product of the input and neuron weights (see previous section); in this case the output values range from $-inf$ to $+inf$ and they are equivalent to a simple linear function.
...
This can be easy done using the example scripts inserted inside our \textsf{NumPyNet} library.
