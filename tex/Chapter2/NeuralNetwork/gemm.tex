...
In particular we evaluate the timing performances over 1000 applications of two the \textsf{GEMM} functions (\textsf{GEMM NN}, i.e considering both matrices in \quotes{normal} shapes; \textsf{GEMM NT}, i.e considering the first matrix as \quotes{normal} and the second transpose) considering matrices of shapes ($100\times100$).
