...
The same functionality can be obtained in the \textsf{C++} version of the code provided by the Byron library in which we compute the right indexes along a nested sequence of for loops (ref. \href{https://github.com/Nico-Curti/Byron/blob/master/src/upsample_layer.cpp}{on-line}).
