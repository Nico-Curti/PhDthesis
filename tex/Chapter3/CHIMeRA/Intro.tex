...
We will start from the preliminary studies performed into the INFN FiloBlu project which allow the creation of the \textsf{SymptomsNet} structure, i.e a \quotes{small} network based on Italian words which connects diseases to related symptoms.
