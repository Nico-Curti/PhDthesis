...
A dataset is \emph{structured} if we can easily manage the informations in it or, in other words, if it is described using a standard data formats and thus if it can be \quotes{quearable}.
